...
var createReporters = function(names, config, emitter) {
  ...
  names.forEach(function(name) {
    ...
    if (name === 'brackets') {
      return multiReporter.reporters.push(new exports.Brackets(config, errorFormatter));
    }
...
exports.Brackets = require('./reporters/Brackets');
//exports.Brackets = require('/Volumes/Artkiller/dev/karma-brackets-reporter');
